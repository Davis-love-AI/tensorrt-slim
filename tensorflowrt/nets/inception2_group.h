...
#ifndef TFRT_INCEPTION2_GROUP_H
#define TFRT_INCEPTION2_GROUP_H
                                 ...
                                 tfrt::map_tensor* end_points=nullptr)
{
    ...
    net = block_mixed_avg<352, 200, 320, 161, 224, 128>(net, sc.sub("Mix_5b"), 1024, end_points);
    net = block_mixed_max<352, 200, 320, 196, 224, 128>(net, sc.sub("Mix_5c"), 1024, end_points);
    return net;
}
