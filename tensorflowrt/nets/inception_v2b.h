                                   ...
                                   tfrt::map_tensor* end_points=nullptr)
{
    ...
    std::vector<nvinfer1::ITensor*>  block1, block2;
    {
        ...
        auto branch11 = conv2d(ssc, "Conv2d_0a_1x1_1").noutputs(B10/4).ksize({1, 1})(net);
                                 ...
                                 tfrt::map_tensor* end_points=nullptr)
{
    ...
    net = conv2d(sc, "Conv2d_1a_7x7").noutputs(64).ksize(7).stride(2)(net);
                          ...
                          tfrt::map_tensor* end_points=nullptr)
{
    ...
    // net = dw_conv2d(sc, "Conv2d_2c_3x3_dw").depthmul(2).ksize(3)(net);
    // outputs.first = conv2d(sc, "Conv2d_2c_1x1l").noutputs(192/2).ksize(1)(net);
    // outputs.second = conv2d(sc, "Conv2d_2c_1x1r").noutputs(192/2).ksize(1)(net);
